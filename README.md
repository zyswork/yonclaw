...
### Skills Marketplace
- **60 bundled skills** with Chinese + English trigger keywords
...
- OAuth provider authentication (Google, OpenAI)
- Voice input (Whisper)
...
2. **Add a provider** in Settings — paste your API key or use OAuth for Google Gemini
